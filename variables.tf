...
variable "ID_RSA_FILE_PATH" {
    ...
    nullable = false
    description = "The file path for ID_RSA_FILE_PATH will be automatically generated by default. If it is changed, it must contain the relative path from git repo folders. Example: ansible/id_rsa_bw4hana, ~/.ssh/id_rsa_bw4hana, /root/.ssh/id_rsa"
}
